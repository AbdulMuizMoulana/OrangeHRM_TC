...
class TestLeavePage:
    ...
    def test_apply_leave_010(self, setup):
        ...
        test_leave_page.enter_from_date("2025-19-12")
        time.sleep(3)
        test_leave_page.enter_to_date("2025-19-12")
        time.sleep(3)
    ...
    def test_assign_leave_011(self, setup):
        ...
        test_assign_leave.enter_from_date("2025-18-12")
        time.sleep(2)
        test_assign_leave.enter_to_date("2025-18-12")
        time.sleep(2)
